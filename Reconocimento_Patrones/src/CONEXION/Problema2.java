...
public class Problema2 extends javax.swing.JFrame {
    ...
    private void guardarDatos() throws SQLException{
       ...
       Connection con = null;
        try {
            ...
            ps = con.prepareStatement("insert into Problema2 ( IdOrden, IdCliente, Respuesta, Firma) values ( ?, ?, ?, ?)");
            ...
            if (res > 0) {
                JOptionPane.showMessageDialog(null, "El Ploblema2 se registro con éxito!");
                limpiarCaja();
            }else{
    ...
    public void eliminarDatos(){
        ...
        try {
            ...
            ps = con.prepareStatement("delete from Problema2 where IdOrden = ?");
            ps.setInt(1, Integer.parseInt(txtIdOrden.getText()));
            int res = ps.executeUpdate();
            if (res > 0) {
    ...
    public void buscarDatos(){
        ...
        try {
            ...
            ps = con.prepareStatement("select * from Ploblema2 where IdOrden=?");
            ps.setInt(1, Integer.parseInt(txtIdOrden.getText()));
    ...
    public void actualizarDatos() throws SQLException{
        ...
        try{
            ...
            int res = ps.executeUpdate();
            if(res>0){
                JOptionPane.showMessageDialog(null, "Ploblema2 modificado"); 
                limpiarCaja();
            }
            else{
                JOptionPane.showMessageDialog(null, "Error al Modificar Problema2");
                limpiarCaja();
            }
        con.close();
        }
    ...
    private void initComponents() {
        ...
        btSeleccion.setText("Seleccionar");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtIdOrden, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lbFirma, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtFirma, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btSeleccion))))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtRespuesta, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                ...
                .addComponent(lbFirma, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btGuardar)
                    .addComponent(btLimpiar)
